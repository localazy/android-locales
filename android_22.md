...
| ar_SY | Arabic (Syria) | values-ar-rSY | values-b+ar+SY |
...
Locales listed above are those known to Android 22. There are also deprecated and legacy locales that are aliases to existing ones.
